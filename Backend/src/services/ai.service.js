...
async function generateInterviewReport({resume, selfDescription, jobDescription}){
    ...
    const prompt = `
        ...
        3. behavioralQuestions:
            ...
            - Use STAR framework in answers

        4. skillGaps:
            - Identify actual missing skills from comparison of resume and job description
            - Include severity

        5. preparationPlan:
            - Create a 10-day preparation plan
            - Each day must contain:
                - day
                - focus
                - minimum 3 actionable tasks
